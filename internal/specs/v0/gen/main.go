...
import (
	...
	"github.com/bbernays/cloudquery/cli/internal/specs/v0"
...
func main() {
	...
	cqgen_jsonschema.GenerateIntoFile(new(specs.Spec), path.Join(currDir(), "..", "schema.json"),
		cqgen_jsonschema.WithAddGoComments("github.com/bbernays/cloudquery/clinternal/specs/v0", path.Join(currDir(), "..")),
